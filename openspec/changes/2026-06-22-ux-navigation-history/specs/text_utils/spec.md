# text_utils Spec — Delta for v0.3.0

## Purpose

Adds the new `ollamachat/core/text_utils.py` headless module exposing `strip_markdown(text)` for the message detail popup and accessibility surface.
